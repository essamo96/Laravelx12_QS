    ...
    <div class="card-body py-4">
        ...
        <form action="" method="POST">
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 fv-row fv-plugins-icon-container">
                    <label class="required fs-5 fw-semibold mb-2">@lang('app.big_number')</label>
                ...
                <div class="col-md-6 fv-row fv-plugins-icon-container">
                    <label class="required fs-5 fw-semibold mb-2">@lang('app.birth_date')</label>
                ...
                <div class="col-md-6 fv-row fv-plugins-icon-container">
                    <label class="required fs-5 fw-semibold mb-2">@lang('app.last_login_at')</label>
                ...
                <div class="col-md-6 fv-row fv-plugins-icon-container">
                    <label class="required fs-5 fw-semibold mb-2">@lang('app.options')</label>
                    <input type="text" class="form-control form-control-solid" name="options" value="{{ $info ? $info->options : old("options") }}">
                </div><div class="row mb-5">
                <div class="col-md-6 fv-row fv-plugins-icon-container">
                    <label class="required fs-5 fw-semibold mb-2">@lang('app.name_en')</label>
                ...
                <div class="col-md-6 fv-row fv-plugins-icon-container">
                    <label class="required fs-5 fw-semibold mb-2">@lang('app.published_at')</label>
                ...
                <div class="col-md-6 fv-row fv-plugins-icon-container">
                    <label class="required fs-5 fw-semibold mb-2">@lang('app.user_id')</label>
                    <input type="number" class="form-control form-control-solid" name="user_id" value="{{ $info ? $info->user_id : old("user_id") }}">
                </div></div><div class="row mb-5">
                <div class="col-md-6 fv-row fv-plugins-icon-container">
                    <label class="required fs-5 fw-semibold mb-2">@lang('app.uuid')</label>
                    <input type="text" class="form-control form-control-solid" name="uuid" value="{{ $info ? $info->uuid : old("uuid") }}">
                </div>
                <div class="col-md-6 fv-row fv-plugins-icon-container">
                    <label class="required fs-5 fw-semibold mb-2">@lang('app.weight')</label>
